  ...
  return (
    <>
      ...
      <div
        ...
        tabindex="-1"
        aria-hidden="true"
        class=" overflow-y-auto overflow-x-hidden fixed flex top-0 right-0 left-0 z-[500] justify-center items-center w-full md:inset-0 h-[calc(100%)] max-h-full bg-black bg-opacity-50"
      >
        <div class="relative p-4 w-full max-w-2xl max-h-full">
          {/* <!-- Modal content --> */}
          <div class="relative  rounded-lg shadow bg-bgColor-trinary">
            {/* <!-- Modal header --> */}
                ...
                <>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="search"
                      id="default-search"
                      class="block w-full p-4 ps-10 text-sm text-white border border-gray-300 rounded-lg bg-transparent "
                      placeholder="Search for food"
                      value={search}
                      onChange={(e) => setSearch(e.target.value)}
                    />
                    <button
                      class="text-white absolute end-2.5 bottom-2.5 bg-blue-default font-medium rounded-lg text-sm px-4 py-2 "
                      type="button"
                      onClick={() => {
                        handleSearch();
                      }}
                ...
                <div class="flex flex-row justify-center items-center">
                  ...
                  {infoLoading && (
                    <div class="flex flex-col justify-center items-center">
                      <div class="animate-spin rounded-full h-6 w-6 border-t-2 border-b-2 border-blue-default"></div>
                    </div>
                  )}
                </div>
              </div>
