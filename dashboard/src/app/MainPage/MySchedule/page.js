    ...
    <div className="grid grid-cols-4">
      <div className="col-span-3">
        ...
        >
          ...
          <div className="mt-3 flex flex-col gap-4 overflow-y-scroll h-[270px] px-2 py-1 ">
            <ScheduleDailyCard
          ...
          <div className="text-2xl text-gray-50 pt-5 px-2 ">Book a course</div>
          <div className="mt-3 flex flex-col gap-4 overflow-y-scroll h-[258px] px-2 py-1 ">
            <ScheduleBookCard
              imageData={"/back&Stretch.png"}
              day={"Monday"}
              sets={"20"}
      ...
      <div className="col-span-1 py-2 flex flex-col items-center" style={{
            height: "calc(100vh - 5rem)",
          }}>
        ...
        <div className="w-full  flex flex-col h-[50%] pt-4 overflow-hidden">
          ...
          <div className="flex flex-row items-center justify-between px-2">
            <div className="text-xl font-medium text-white">My Upcoming Courses</div>
            <button className="text-blue-default flex flex-row  items-center justify-between">
              <div className="text-sm mr-1">View All</div>
              <div>
                <FaAngleRight />
